package com.fedorovsky.mkdservice.e2e.be.base
...
interface DockerCompose {
     ...
     */
    val user: String get() = throw kotlin.UnsupportedOperationException("no user")
    /**
     * Пароль для подключения (доступен не везде)
     */
    val password: String get() = throw kotlin.UnsupportedOperationException("no password")
