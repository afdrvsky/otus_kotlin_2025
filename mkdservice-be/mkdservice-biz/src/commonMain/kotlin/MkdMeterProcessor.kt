...
import com.fedorovsky.mkdservice.biz.general.getMeterState
import com.fedorovsky.mkdservice.biz.general.getMeterStates
...
import com.fedorovsky.mkdservice.biz.permissions.accessValidation
import com.fedorovsky.mkdservice.biz.permissions.chainPermissions
import com.fedorovsky.mkdservice.biz.permissions.frontPermissions
...
import com.fedorovsky.mkdservice.biz.repo.repoReadPrevious
...
import com.fedorovsky.mkdservice.biz.validation.validateAmountMoreThanPrevious
    ...
    private val businessChain = rootChain<MeterReadingContext> {
        ...
        operation("Передача показания ПУ", MeterCommand.CREATE) {
            ...
            chain {
                ...
                title = "Получить предыдущее показание"
                repoReadPrevious("Чтение показания из БД")
            ...
            validation {
                ...
                validateAmountMoreThanPrevious("Проверка, что сумма больше или равна предыдущей")
            ...
            getMeterState("Вычисление состояния показания")
        ...
        operation("Получить показания", MeterCommand.READ) {
            ...
            frontPermissions("Вычисление пользовательских разрешений для фронтенда")
            getMeterStates("Вычисление состояния показания")
            prepareResult("Подготовка ответа")
        }
